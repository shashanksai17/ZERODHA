...
function productPage() {
  return (
    <>
      ...
      productLink=""
      productURL="media/images/console.png"
      />
      <LeftSection
      ...
      <RightSection
       ...
       productDiscription="The Build powerful trading platforms and experiences with our super simple HTTP/JSON APIs. If you are a startup, build your investment app and showcase it to our clientbase.central dashboard for your Zerodha account. Gain insights into your trades and investments with in-depth reports and visualisations."
      productLink=""
      productURL="media/images/kiteconnect.png" 
      />
      <LeftSection
      ...
      <p className="text-muted text-center fs-3">
